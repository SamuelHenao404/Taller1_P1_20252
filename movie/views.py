...
def signup(request):
    if request.method == 'POST':
        ...
        # Verificar si viene de un formulario simple de email
        email = request.GET.get('email')
        if email:
            # Si viene con email, mostrar mensaje de confirmación
            return render(request, 'signup.html', {'email': email, 'simple_signup': True})
        else:
            # Si no, mostrar formulario completo de registro
